#!/usr/bin/env bash
# Scenario 13: Multi-Cluster — run.sh
# Registers sandbox + production clusters, verifies routing and promotion across clusters.
...
CLUSTER_NAME="${SCENARIO_CLUSTER:-chorister-scenario-13}"
SKIP_SETUP=0
SKIP_TEARDOWN=0
