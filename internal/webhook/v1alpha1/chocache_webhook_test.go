...
var _ = Describe("ChoCache Webhook", func() {
	var validator ChoCacheCustomValidator

	BeforeEach(func() {
		validator = ChoCacheCustomValidator{}
	})

	Context("When validating ChoCache", func() {
		It("Should admit a valid cache with size", func() {
		...
		It("Should admit a valid cache with resources", func() {
			obj := &choristerv1alpha1.ChoCache{
				Spec: choristerv1alpha1.ChoCacheSpec{
					Application: "myapp",
					Domain:      "sessions",
		...
		It("Should apply same rules on update", func() {
			old := &choristerv1alpha1.ChoCache{
				Spec: choristerv1alpha1.ChoCacheSpec{
					Application: "myapp",
					Domain:      "sessions",
					Size:        "small",
			...
			updated := &choristerv1alpha1.ChoCache{
				Spec: choristerv1alpha1.ChoCacheSpec{
					Application: "",
					Domain:      "sessions",
					Size:        "small",
