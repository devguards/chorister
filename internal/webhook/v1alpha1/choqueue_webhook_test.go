...
var _ = Describe("ChoQueue Webhook", func() {
	var validator ChoQueueCustomValidator

	BeforeEach(func() {
		validator = ChoQueueCustomValidator{}
	})

	Context("When validating ChoQueue", func() {
		It("Should admit a valid queue with size", func() {
		...
		It("Should admit a valid queue with resources", func() {
			obj := &choristerv1alpha1.ChoQueue{
				Spec: choristerv1alpha1.ChoQueueSpec{
					Application: "myapp",
					Domain:      "events",
		...
		It("Should apply same rules on update", func() {
			old := &choristerv1alpha1.ChoQueue{
				Spec: choristerv1alpha1.ChoQueueSpec{
					Application: "myapp",
					Domain:      "events",
					Size:        "small",
			...
			updated := &choristerv1alpha1.ChoQueue{
				Spec: choristerv1alpha1.ChoQueueSpec{
					Domain: "events",
					Size:   "small",
				},
