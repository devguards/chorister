...
- [ ] **CLI-0.1 — Create `internal/query/` package with client abstraction**
...
- [ ] **CLI-0.2 — Create `internal/report/` package with output model**
...
- [ ] **CLI-0.3 — CLI output framework: `--output` flag support**
...
- [ ] **CLI-1.6 — `admin domain delete <name>`**
...
- [ ] **CLI-3.3 — `sandbox status` subcommand**
...
- [ ] **CLI-3.4 — Enhanced `sandbox list` with cost/age columns**
...
- [ ] **CLI-4.3 — Enhanced `diff` with `--output` format**
...
- [ ] **CLI-5.2 — `admin vulnerabilities get <domain>`**
...
- [ ] **CLI-8.2 — `get <type> <name>` — generic resource inspector**
...
- [ ] **CLI-9.1 — Enhanced `admin member add` with proper flags**
...
- [ ] **CLI-9.2 — Enhanced `admin member list` with filtering**
...
- [ ] **CLI-9.3 — Enhanced `admin member audit`**
  - `internal/report/compliance.go`:
